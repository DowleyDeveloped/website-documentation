...
class InstallController extends Controller
{
	...
	public function actionInstallTemplates()
	{
		...
		$templatesFolder = Craft::getAlias('@templates') . '/website-documentation';

		// Get Base Templates Path
		$websiteDocs = Craft::getAlias('@websitedocumentation') . '/templates/website-documentation';
		...
		try {
			...
			return $this->redirect("website-documentation/settings/templates");
		}
